...
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{images/GDD-Drawing_Problemstatement.png}
...
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\textwidth, trim=0 0 0 0, clip]{images/form_flatness.png}
  \caption{Flatness tolerance symbol}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\textwidth, trim=0 0 0 0, clip]{images/form_cylindricity.png}
