...
\usepackage{graphicx} \usepackage{amsmath} \usepackage[margin=1in]{geometry} \usepackage{caption} \usepackage{lmodern} \usepackage{parskip} \usepackage{fancyhdr}
...
\begin{figure}[h!] \centering \includegraphics[width=0.9\textwidth]{Documentation\images\GDD-Drawing_Problemstatement.png} \caption{AI-based detection pipeline: YOLO identifies oval callouts and symbol blocks; image classification labels GD&T symbols; OCR extracts values for feasibility checking.} \label{fig:pipeline_example} \end{figure}
