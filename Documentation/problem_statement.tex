...
\usepackage[utf8]{inputenc} \usepackage{graphicx} \usepackage{amsmath} \usepackage[margin=1in]{geometry} \usepackage{caption} \usepackage{lmodern} \usepackage{parskip} \usepackage{textcomp} % For Ø and other symbols \usepackage{fancyhdr}

\pagestyle{fancy} \fancyhf{} \rhead{Feasibility Analysis – GD&T Drawing AI} \lhead{Problem Statement} \rfoot{\thepage}
...
\begin{figure}[h!] \centering \includegraphics[width=0.9\textwidth]{GDD-Drawing-Example.png} \caption{AI-based detection pipeline: YOLO identifies oval callouts and symbol blocks; image classification labels GD&T symbols; OCR extracts values for feasibility checking.} \label{fig:pipeline_example} \end{figure}
