...
\usepackage[utf8]{inputenc}  % Ensure proper UTF-8 character support
...
\usepackage{hyperref}
\usepackage{amsmath}
\usepackage{wasysym}         % Provides \diameter symbol
\usepackage{newunicodechar}  % Support for Unicode characters
\usepackage{float}

\hypersetup{colorlinks=true, urlcolor=blue, linkcolor=blue}
\newunicodechar{\diameter}{\diameter}  % Define the Unicode diameter symbol
