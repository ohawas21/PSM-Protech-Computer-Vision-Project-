...
\begin{itemize}
  ...
  \item \textbf{Optical Character Recognition (OCR):} Extract numerical tolerance values (e.g., $\pm$0.05, Ø10.2), text annotations (e.g., ``CC'', ``3x''), and datums (A, B, C).
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{GDD-Drawing-Example.png}
...
Path("problem_statement.tex").write_text(latex_code)
